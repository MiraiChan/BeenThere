...
public enum AppStrings {
    ...
    public static let logEveryPlace: LocalizedStringResource = "Log every place you've visited. Build a record of your family's favorite spots."
    public static let everyDetailCaptured: LocalizedStringResource = "Every Detail Captured"
    public static let activitiesRatingsNotes: LocalizedStringResource = "Activities, ratings, notes - everything that made each visit unforgettable."
